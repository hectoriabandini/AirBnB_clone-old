...
class TestBaseModel(unittest.TestCase):
    ...
    def test_first_task(self):
        """Test  class and to_dict creation"""
        my_model = BaseModel()
    ...
    def test_file_save(self):
        """Test that info is saved to file json"""
        b3 = BaseModel()
        b3.save()
    ...
    def test_constructor_kwargs(self):
        """Test kwargs constructs as attributes values"""
        obj = BaseModel()
        obj.name = "Holberton"
        obj.my_number = 89
